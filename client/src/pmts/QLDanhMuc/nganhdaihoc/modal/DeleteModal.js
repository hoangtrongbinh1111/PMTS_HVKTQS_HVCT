...
import { xoaNganhDaiHoc } from '../../../../api/nganhDaiHoc'
...
const DeleteModal = ({ open, handleModal, fetchUser, infoEdit }) => {
  ...
  const _handleXoaNDH = async () => {
    setLoading(true)
    const res = await xoaNganhDaiHoc({
      id: infoEdit.maNganh
    })
  ...
  return (
    ...
    >
      <ModalHeader className='mb-1' toggle={handleModal} close={CloseBtn} tag='div'>
        <h5 className='modal-title'>Xóa ngành đại học</h5>
      </ModalHeader>
      <ModalBody className='flex-grow-1'>
        ...
        <Button className='me-1' color='primary' onClick={_handleXoaNDH}>
