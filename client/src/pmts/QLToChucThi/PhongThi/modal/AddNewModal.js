...
import { taoPhongThi } from "../../../../api/phongThi"
import style from "../../../../assets/scss/index.module.scss"
import classnames from "classnames"

const AddNewModal = ({ open, handleModal, fetchUser, listDiaDiemThi }) => {
  // ** State
  ...
  return (
    ...
    >
      <ModalHeader
        ...
        tag="div"
      >
        <h5 className="modal-title">Tạo phòng thi</h5>
      </ModalHeader>
        ...
        <Form onSubmit={handleSubmit(_handleThemMT)}>
          ...
          <div className="mb-1">
            ...
            <input
              ...
              {...register("giangDuongPhong", { required: true })}
          ...
          <div className="mb-1">
            ...
            <Input
              ...
              type="select"
              value={maDidiem}
              {...register("maDidiem", { required: true })}
              className={`${classnames({
