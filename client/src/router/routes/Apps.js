...
const NhomNguoiDung = lazy(() => import('../../pmts/QLHeThong/nhomNguoiDung'))
const PhanQuyen = lazy(() => import('../../pmts/QLHeThong/phanQuyen/ListPermission'))
const DotTuyenSinh = lazy(() => import('../../pmts/QLHeThong/dotTuyenSinh'))
const NguoiDung = lazy(() => import('../../pmts/QLHeThong/nguoiDung'))
const CauHinhHeThong = lazy(() => import('../../pmts/QLHeThong/cauHinhHeThong'))

// Menu tổ chức thi
const ChiTieuTuyenSinh = lazy(() => import('../../pmts/QLToChucThi/chiTieuTuyenSinh'))
...
const AppRoutes = [
  ...
  {
    element: <PhanQuyen />,
    path: '/QLHeThong/NhomNguoiDung'
  },
  {
    element: <NguoiDung />,
    path: '/QLHeThong/NguoiDung'
  },
  // {
  //   element: <PhanQuyen />,
  //   path: '/QLHeThong/PhanQuyen'
  // },
  {
    element: <DotTuyenSinh />,
    path: '/QLHeThong/DotTuyenSinh'
  },
  {
    element: <CauHinhHeThong />,
    path: '/QLHeThong/CauHinhHeThong'
  },
  {
    element: <ChiTieuTuyenSinh />,
    path: '/QLToChucThi/ChiTieuTS'
  }
]
