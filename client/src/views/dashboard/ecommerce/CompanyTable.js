...
const CompanyTable = () => {
  ...
  return (
    <Card className='card-company-table'>
      <CardBody>
      <CardTitle tag='h4'>Chỉ tiêu tuyển sinh qua các năm</CardTitle>
      <Table responsive>
        <thead>
          <tr>
            <th style={{backgroundColor: '#09a863', color: '#fff'}}>Năm tuyển sinh</th>
            <th style={{backgroundColor: '#09a863', color: '#fff'}}>Chỉ tiêu quân sự</th>
            <th style={{backgroundColor: '#09a863', color: '#fff'}}>Chỉ tiêu dân sự</th>
            <th style={{backgroundColor: '#09a863', color: '#fff'}}>Tổng</th>
            {/* <th>Sales</th> */}
          </tr>
        </thead>
        <tbody>{
        data?.map((item, index) => {
          return <tr>
            <td style={{textAlign: 'center'}}>{item.nam}</td>
            <td style={{textAlign: 'center'}}>{item.soLuongQS}</td>
            <td style={{textAlign: 'center'}}>{item.soLuongDS}</td>
            <td style={{textAlign: 'center'}}>{item.tong}</td>
          </tr>
        })
        }</tbody>
      </Table>
