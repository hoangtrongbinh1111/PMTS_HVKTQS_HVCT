...
const GoalOverview = props => {
  ...
  return data !== null ? (
    <Card>
      <CardHeader>
        <CardTitle tag='h4'>Tỷ lệ trúng tuyển trung bình</CardTitle>
      ...
      <Row className='border-top text-center mx-0'>
        <Col xs='6' className='border-end py-1'>
          <CardText className='text-muted mb-0'>Trúng tuyển</CardText>
          <h3 className='fw-bolder mb-0'>{data.completed}</h3>
        </Col>
        <Col xs='6' className='py-1'>
          <CardText className='text-muted mb-0'>Không trúng tuyển</CardText>
