...
const Profile = () => {
  ...
  useEffect(() => {
    // axios.get('/profile/data').then(response => console.log("res", response.data))
  }, [])
  return (
    <Fragment>
      {/* <Breadcrumbs title='Thông tin cá nhân' data={[{ title: '' }, { title: '' }]} /> */}
      {data !== null ? (
        <div id='user-profile'>
          <Row>
            <Col sm='12'>
          ...
          <section id='profile-info'>
            <Row>
              <Col lg={{ size: 12, order: 1 }} sm={{ size: 12 }} xs={{ order: 2 }}>
                ...
                {/* <ProfileSuggestedPages data={data} /> */}
                {/* <ProfileTwitterFeeds data={data} /> */}
              </Col>
