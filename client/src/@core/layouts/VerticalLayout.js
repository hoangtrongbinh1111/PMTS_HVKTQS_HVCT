...
const VerticalLayout = props => {
  ...
  return (
    ...
    >
      ...
      <footer
        className={classnames(`footer footer-light ${footerClasses["sticky"] || 'footer-static'}`, {
          'd-none': footerType === 'hidden'
        })}
      >
        {footer ? footer : <FooterComponent footerType={"sticky"} footerClasses={footerClasses} />}
      </footer>
