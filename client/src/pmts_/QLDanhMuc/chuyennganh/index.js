...
// import API
import { getListChuyenNganh, searchListChuyenNganh, taoChuyenNganh, exportChuyenNganh, exportChuyenNganhTemplate } from '../../../api/chuyenNganh'
...
const ChuyenNganh = () => {
    ...
    const handleExportFileExcel = async () => {
        const res = await exportChuyenNganh()
    }
    const handleExportFileTemplate = async () => {
        const res = await exportChuyenNganhTemplate()
    }
    ...
    const handleExportFileDocx = async (data) => {
        const request = await fetch("/../../template/nganhtuyensinh/dsdiachidaotao.docx")
        ...
        <Fragment>
            ...
            <Card style={{ backgroundColor: 'white' }}>
                <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
                    <CardTitle tag='h4'>Danh sách chuyên ngành tuyển sinh</CardTitle>
                    <div className='d-flex mt-md-0 mt-1'>
                        <UncontrolledButtonDropdown>
                            ...
                            <DropdownMenu>
                                {/* {ability.can('read', 'dschuyennganh') &&
